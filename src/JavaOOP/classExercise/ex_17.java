...
public class ex_17 {
    ...
    private static void exercise3() {
        ...
        for(int i=0; i<studentAges.size(); i++){
            System.out.println(createNewCourse(studentNames.get(i), studentAges.get(i)));
            somma += studentAges.get(i);
        }
        somma /= studentAges.size();
        System.out.println(somma);

        }

    private static Course createNewCourse(String name, Integer age){
