...
public class ex_6 {
    ...
    private static void exercise1() {
        ...
        String ja = "Truth is treason in the empire of lies";
        System.out.println(ja.toLowerCase());
    ...
    private static void exercise2() {
        ...
        String middleName = "Cineva";
        String lastName = "Jassai";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "2" + false + 'J' + 7.39; // <--- Edit this line
