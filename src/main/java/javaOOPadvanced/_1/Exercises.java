...
//        for (Integer num : ourSet) {
//           while (ourSet.contains(num) && num == 1) {
//               ourSet.remove(num);
//           }
//        }
    ...
    private static void exercise2() {
        ...
        //2b. What will this output? [Will output the following: apple, banana, orange, kiwi, mango, grapes, pear in no particular order.]
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise3() {
        ...
        for (Integer number : numbers) {
          ...
          min = Math.min(min, number);       // Your code
        }
